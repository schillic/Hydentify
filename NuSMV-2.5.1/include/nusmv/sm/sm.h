...
EXTERN void Sm_BannerPrint ARGS((FILE * file));
EXTERN void Sm_BannerPrintLibrary ARGS((FILE * file));

EXTERN void Sm_BannerPrint_nusmv_library ARGS((FILE * file));
EXTERN void Sm_BannerPrint_cudd ARGS((FILE * file));
EXTERN void Sm_BannerPrint_minisat ARGS((FILE * file));
EXTERN void Sm_BannerPrint_zchaff ARGS((FILE * file));
EXTERN int Sm_NusmvrcSource ARGS((void));
