...
/**Type************************************************************************
  ...
  Description        [
  NB for developers: the struct AddArray_TAG is actually never defined,
  but just used to create a new type (for proper type-checking).
  The actually type below AddArray_ptr is array_t*.]
...
EXTERN void AddArray_set_n ARGS((AddArray_ptr self, int number, add_ptr add));
